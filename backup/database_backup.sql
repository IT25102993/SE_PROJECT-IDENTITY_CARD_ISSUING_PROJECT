...
INSERT INTO `applicants` (`applicant_id`, `national_id_number`, `first_name`, `last_name`, `date_of_birth`, `gender`, `address`, `phone_number`, `email`, `registered_at`) VALUES (2, '200200461849', 'KULASINGHA', 'GAMAGE NADUN NIMESH', '2002-01-03 18:00:00', 'Male', '65/6,siyambalape waththa,dewala rd,delgoda', '0703064656', 'kgnadunnimesh@gmail.com', '2026-09-17 03:30:50') ON DUPLICATE KEY UPDATE `first_name`=VALUES(`first_name`);
INSERT INTO `applicants` (`applicant_id`, `national_id_number`, `first_name`, `last_name`, `date_of_birth`, `gender`, `address`, `phone_number`, `email`, `registered_at`) VALUES (3, '200015613237', 'Nimesh', 'namnugama', '2000-06-03 18:00:00', 'Male', 'test address', '071 251 3663', 'sakaleyt@gmail.com', '2026-09-17 04:45:45') ON DUPLICATE KEY UPDATE `first_name`=VALUES(`first_name`);
...
INSERT INTO `identity_cards` (`card_id`, `card_number`, `application_id`, `applicant_id`, `issue_date`, `expiry_date`, `status`, `issued_by`, `created_at`) VALUES (2, '200200461849', 2, 2, '2026-09-16 18:30:00', '2036-09-16 18:30:00', 'Active', 29, '2026-09-17 04:24:49') ON DUPLICATE KEY UPDATE `card_number`=VALUES(`card_number`);
INSERT INTO `identity_cards` (`card_id`, `card_number`, `application_id`, `applicant_id`, `issue_date`, `expiry_date`, `status`, `issued_by`, `created_at`) VALUES (4, '200015613237', 3, 3, '2026-09-16 18:30:00', '2036-09-16 18:30:00', 'Active', 17, '2026-09-17 05:16:03') ON DUPLICATE KEY UPDATE `card_number`=VALUES(`card_number`);
...
-- [2026-09-17T07:28:12.030Z] INSERT INTO audit_logs (user_id, action, details) VALUES (?, ?, ?)
-- [2026-09-17T07:28:56.782Z] System startup baseline sync
-- [2026-09-17T07:29:26.777Z] INSERT INTO audit_logs (user_id, action, details) VALUES (?, ?, ?)
-- [2026-09-17T07:29:37.722Z] INSERT INTO audit_logs (user_id, action, details) VALUES (?, ?, ?)
-- [2026-09-17T07:29:46.139Z] INSERT INTO audit_logs (user_id, action, details) VALUES (?, ?, ?)
